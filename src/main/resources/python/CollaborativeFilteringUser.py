...
# Load the dataset
rt = pd.read_csv('E:\\CayvaCaCanh\\src\\main\\resources\\python\\Py-csv\\rating.csv')
p = pd.read_csv('E:\\CayvaCaCanh\\src\\main\\resources\\python\\Py-csv\\products.csv')
...
# Chuyển đổi các đối tượng dự đoán của Surprise thành định dạng phù hợp với các chỉ số đánh giá của sklearn
...
# Chuyển các nhãn thực tế và nhãn dự đoán thành dạng nhị phân (ví dụ, sử dụng một ngưỡng)
